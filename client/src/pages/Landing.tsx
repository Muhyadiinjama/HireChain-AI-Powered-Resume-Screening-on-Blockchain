...
const Landing = () => {
    ...
    return (
        <div className="overflow-hidden">
            <section className="relative pt-16 md:pt-24 pb-24 md:pb-32 flex flex-col items-center justify-center text-center px-4 md:px-8">
                ...
                <div className="w-full max-w-5xl mx-auto">
                    <div className="inline-flex items-center space-x-2 bg-brand-secondary/10 dark:bg-brand-secondary/20 px-4 py-2 rounded-full text-brand-secondary dark:text-brand-secondary font-semibold mb-8 shadow-sm">
                        <Sparkles size={18} />
                        <span>AI-Powered Fair Recruitment</span>
                    </div>

                    <h1 className="text-4xl md:text-7xl font-extrabold tracking-tight-custom text-gray-900 dark:text-white mb-6 drop-shadow-sm transition-colors duration-300">
                        HireChain <br />
                        <span className="premium-text-gradient">AI-Powered Resume Screening</span>
                    </h1>

                    <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-12 leading-relaxed transition-colors duration-300">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
                        <button
                            ...
                            className="premium-gradient text-white w-full sm:w-auto sm:min-w-[210px] px-6 md:px-8 py-3.5 md:py-4 rounded-2xl font-bold flex items-center justify-center space-x-3 shadow-lg hover:scale-105 transition-transform active:scale-95"
                        >
                            <Upload size={20} />
                        ...
                        <button
                            ...
                            className="bg-white dark:bg-dark-surface border-2 border-brand-primary/20 dark:border-brand-primary/30 text-gray-700 dark:text-gray-200 w-full sm:w-auto sm:min-w-[210px] px-6 md:px-8 py-3.5 md:py-4 rounded-2xl font-bold flex items-center justify-center space-x-3 hover:bg-gray-50 dark:hover:bg-dark-main transition-colors shadow-sm"
                        >
                    ...
                    <div className="mt-12 flex flex-wrap items-center justify-center gap-4 md:gap-6 text-sm font-bold text-gray-500 dark:text-gray-400 transition-colors duration-300">
                        <div className="inline-flex items-center gap-2 rounded-full bg-white/80 dark:bg-dark-surface/80 px-4 py-2 shadow-sm border border-gray-100 dark:border-gray-800">
            ...
            <section className="py-20 bg-white dark:bg-dark-main transition-colors duration-300">
                <div className="max-w-7xl mx-auto px-4 md:px-8">
                    ...
                    <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-5">
                        {[
                            ...
                            <div key={feature.title} className="rounded-[32px] border border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-dark-surface p-7 shadow-sm hover:shadow-xl transition-all">
                                <div className="h-14 w-14 rounded-2xl bg-white dark:bg-dark-card flex items-center justify-center shadow-sm">
                                    {feature.icon}
                                </div>
                                <h3 className="mt-6 text-xl font-black text-gray-900 dark:text-white transition-colors duration-300">{feature.title}</h3>
            ...
            <section className="py-20 bg-primary-50 dark:bg-primary-900/10 transition-colors duration-300">
                <div className="max-w-7xl mx-auto px-4 md:px-8">
                    <div className="max-w-3xl mx-auto mb-12 text-center">
                    ...
                    <div className="grid lg:grid-cols-3 gap-6">
                        {[
                            ...
                            <div key={role.title} className="rounded-[32px] bg-white dark:bg-dark-surface border border-primary-100 dark:border-primary-900/30 p-7 shadow-sm transition-colors duration-300">
                                <div className="h-14 w-14 rounded-2xl bg-gray-50 dark:bg-dark-main flex items-center justify-center">
                                    {role.icon}
                                </div>
                                <h3 className="mt-6 text-2xl font-black text-gray-900 dark:text-white transition-colors duration-300">{role.title}</h3>
                ...
                <div className="max-w-6xl mx-auto px-4 md:px-8">
                    ...
                    <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-5">
                        {[
                            ...
                            <div key={step.step} className="rounded-[30px] border border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-dark-surface p-6 shadow-sm transition-colors duration-300">
                                ...
                                <h3 className="text-xl font-black text-gray-900 dark:text-white transition-colors duration-300">{step.title}</h3>
            ...
            <section className="py-16 md:py-24">
                <div className="max-w-6xl mx-auto px-4 md:px-8">
                    <div className="premium-gradient rounded-[36px] md:rounded-[42px] p-8 md:p-12 text-white shadow-2xl relative overflow-hidden">
                        ...
                        <div className="relative max-w-3xl">
                            ...
                            <p className="mt-5 text-lg text-primary-100 opacity-90 leading-relaxed">
                            ...
                            <div className="mt-8 flex flex-col sm:flex-row gap-4">
                                <button
                                    onClick={primaryAction}
                                    className="bg-white text-brand-primary px-8 py-4 rounded-2xl font-black shadow-lg hover:bg-gray-50 transition-colors"
                                >
                                    {!user ? 'Get Started' : user.role === 'candidate' ? 'Browse Jobs' : 'Go to Dashboard'}
                                </button>
                                <button
                                    onClick={() => navigate('/blockchain')}
                                    className="bg-white/15 backdrop-blur-sm border border-white/25 px-8 py-4 rounded-2xl font-bold hover:bg-white/20 transition-colors flex items-center justify-center gap-3"
                                >
